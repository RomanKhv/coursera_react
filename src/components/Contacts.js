                    ...
                    <div className="col-12 col-md-9">
                        <LocalForm onSubmit={values => this.handleSubmit(values)}>
                            <div className="form-group">
                                ...
                                <Col md={9}>
                                    <Control.text model=".firstname" id="first_name" name="firstname"
                            ...
                            <div className="form-group">
                                ...
                                <Col md={9}>
                                    <Control.text model=".telnum" id="telnum" name="telnum"
                                        ...
                                        validators={{ required, minLength: minLength(3), maxLength: maxLength(25), isNumber }}
                                    />
                            ...
                            <div className="form-group">
                                ...
                                <Col md={3}>
                                    <Control.select model=".contactType" name="contactType" className="form-control-select">
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Control.select>
                                </Col>
                            ...
                            <div className="form-group">
                                ...
                                <Col md={9}>
                                    <Control.textarea model=".message" id="message" name="feedback" rows={12} className="form-control" />
                                </Col>
                            </div>
                            <div className="form-group">
